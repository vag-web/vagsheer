...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    if (isClient && navigator.clipboard) {
      navigator.clipboard.writeText("info@vagsheer.com").then(() => {
        setCopied(true);
      ...
      >
        ...
        <div
          className={`absolute 
            ...
            ${id === 3 && "-bottom-10"} right-0  ${
            id === 5 &&
            "w-full opacity-100 object-cover object-center h-full -bottom-0 "
          } `}
        >
          {spareImg && (
            <img
        ...
        >
          <div className="font-sans font-medium md:max-w-40 md:text-xs lg:text-base text-sm text-white z-10">
            {description}
          </div>
